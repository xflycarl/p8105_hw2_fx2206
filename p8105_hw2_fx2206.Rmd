...
Based on the available data, the total weight of trash collected by Professor Trash Wheel is `r prof_total_weight` tons. During June 2022, Gwynns Falls Trash Wheel collected `r as.character(gwynnda_cigarettes)` cigarette butts.
